...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
         ...
         // LLAMADA SP
         cstmt = (SQLServerCallableStatement) con.prepareCall("{? = call dbo.SP_IVR_WA_ConsultaCliente(?)}");
		 ...
		 LoggerMensaje += " SP_JSP_WhatsApp_ConsultaCliente.jsp tardo en ejecutarse:" + elapsedTime;
