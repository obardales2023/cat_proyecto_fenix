...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	try {
		...
		String trxToken = additionalParams.get("TrxToken");
		String sesionUUID = additionalParams.get("SessionUUID");
		String clave = additionalParams.get("Clave");
		String tarjeta = additionalParams.get("Tarjeta");
		...
		ValidacionPinPanResponse respuestaOut = clientWS.ValidacionPinPan(token, trxToken, sesionUUID, clave, tarjeta, url);

		System.out.println("WS[ValidaClave]> respuestaOut.getResponseCode: " + respuestaOut.getResponseCode());
		System.out.println("WS[ValidaClave]> respuestaOut.getResponseMessage: " + respuestaOut.getResponseMessage());
		System.out.println("WS[ValidaClave]> respuestaOut.getHTTPCode: " + respuestaOut.getHTTPCode());
		
		result.put("HttpCode",respuestaOut.getHTTPCode());
		result.put("ResponseCode",respuestaOut.getResponseCode());
