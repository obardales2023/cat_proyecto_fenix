...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	System.out.println("INICIO WS[CrearSesionCert]");
	...
	try {
		...
		result.put("sesion_id","-1");
		
		System.out.println("WS[CrearSesionCert]> CallID: " + callid + ", URL: " + url + ", Token: " + token + ", guid_persona: " + guid_persona + ", cliente_id: " + cliente_id);
		MainRestWS clientWS = new MainRestWS(callid); 
		CreateSessionCRMResponse respuestaOut = clientWS.CreateSessionCRM("bearer " + token, guid_persona , cliente_id , url);

		System.out.println("WS[CrearSesionCert]> respuestaOut.getId_sesion: " + respuestaOut.getId_sesion());
		System.out.println("WS[CrearSesionCert]> respuestaOut.getHTTPCode: " + respuestaOut.getHTTPCode());
		
		result.put("HttpCode",respuestaOut.getHTTPCode());
		result.put("sesion_id",respuestaOut.getId_sesion());
	...
	System.out.println("WS[CrearSesionCert]> Out HttpCode : " + result.get("HttpCode").toString());
    System.out.println("FIN WS[CrearSesionCert]");
