...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	System.out.println("INICIO WS[ObtieneEWT]");
	...
	try {
		...
		String vq = additionalParams.get("VQ");
		
		result.put("HttpCode","-1");
		result.put("ewt","None");

		
		System.out.println("WS[ObtieneEWT]> CallID: " + callid + ", URL: " + url + ", VirtualQueue: " + vq);
		EWT ewt = new EWT(); 
		ewt.ObtenerEwt(vq, url);
		
		System.out.println("WS[ObtieneEWT]> HTTPCode: " + ewt.get_HTTPCode());
		System.out.println("WS[ObtieneEWT]> EWT: " + ewt.getEwt());

		
		result.put("HttpCode",ewt.get_HTTPCode());
		result.put("ewt",ewt.getEwt());
	...
	System.out.println("WS[ObtieneEWT]> Out HttpCode : " + result.get("HttpCode").toString());
    System.out.println("FIN WS[ObtieneEWT]");
