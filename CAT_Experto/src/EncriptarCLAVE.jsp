...
<%@page import="cl.sixbell.cat.utils.*" %>
<%!
...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	System.out.println("INICIO WS[EncriptarRUT]");
    
    JSONObject result = new JSONObject();
	
	try {
		String callid = additionalParams.get("CallID");
		String rut = additionalParams.get("var_RUT");
		String key= "dGkjnFTHJklpdsqujtcfvAvnWeBcbpro";
		
		callid	= "01NAIGH6J09MN0LH1K52G2LAES00LDT5";
		rut = "1234";
		
		result.put("CLAVE_Encriptada","-1");
				
		System.out.println("WS[EncriptarC]> CallID: " + callid + ", var_RUT: " + rut);
		
		String CLAVE_Encriptado = EncriptarClave.encrypt(rut, key);

		
		
		result.put("CLAVE_Encriptada",RUT_Encriptado);
