...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	String ivr = state.getString("IVR");
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
         ...
         // LLAMADA SP
         cstmt = (SQLServerCallableStatement) con.prepareCall("{? = call dbo.SP_JSP_WhatsApp_RetornaValor(?)}");
        		
         //PASO DE VARIABLES A SP
         cstmt.registerOutParameter(1, Types.INTEGER);
         cstmt.setString(2, ivr);
		 ...
		 LoggerMensaje += "SP_JSP_WhatsApp_ResetValor.jsp tardo en ejecutarse:" + elapsedTime;
