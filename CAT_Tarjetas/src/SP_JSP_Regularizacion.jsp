...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
         ...
         // LLAMADA SP
		 // (2) @Rut varchar(20), (3) @EXISTE varchar(1) output, (4) @CLASIFICACION varchar(20) output
		 ...
		 LoggerMensaje += "Valor de Retorno de Ejecucion de SP:" + returnSP + " varExiste[" + varExiste + "] varClasificacion[" + varClasificacion + "]";
		 LoggerMensaje += " JS SP_JSP_ConsultaVip.jsp tardo en ejecutarse:" + elapsedTime;
		...
		//FINALIZA TIMER
		 ...
		 result.put("varFonoVipDB",varExiste);
		 result.put("varNombreVipDB",varClasificacion);
