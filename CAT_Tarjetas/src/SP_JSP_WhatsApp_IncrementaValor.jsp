...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
         ...
         // LLAMADA SP
         cstmt = (SQLServerCallableStatement) con.prepareCall("{? = call dbo.SP_IVR_WA_IncrementaValor(?)}");
		 ...
		 LoggerMensaje += "JS SP_WhatsApp_IncrementaValor tardo en ejecutarse:" + elapsedTime;
