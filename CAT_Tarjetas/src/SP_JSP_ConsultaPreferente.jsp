...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	String varSalida = ""; 
	int returnSP = 4;
	String varFonoPreferenteDB = ""; 
	String varNombrePreferenteDB = ""; 
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
		 ...
		 LoggerMensaje += "Valor de Retorno de Ejecucion de SP:" + returnSP + " varFonoPreferenteDB[" + varFonoPreferenteDB + "] varNombrePreferenteDB[" + varNombrePreferenteDB + "]";
		 LoggerMensaje += "JS SP_JSP_ConsultaPreferente.jsp tardo en ejecutarse:" + elapsedTime;
