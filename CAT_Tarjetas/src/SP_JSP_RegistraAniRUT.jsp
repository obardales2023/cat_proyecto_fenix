...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	String Var5 = state.getString("varValidaRUT");
	String Var6= state.getString("var_log_hora_ini");
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
         ...
         // LLAMADA SP
         cstmt = (SQLServerCallableStatement) con.prepareCall("{? = call dbo.SP_IVR_RegistraLlamada_ANIRUT(?, ?, ?, ?, ?, ?, ?)}");
																
        		
         //PASO DE VARIABLES A SP
         cstmt.registerOutParameter(1, Types.INTEGER);
         cstmt.setString(2, idLlamada);
         cstmt.setString(3, numMovil);
         cstmt.setString(4, Var3);
         cstmt.setString(5, Var4);
         cstmt.setString(6, Var5);
         cstmt.setString(7, Var6);
         cstmt.setString(8, Var7);
		 ...
		 LoggerMensaje += " JS SP_JSP_RegistraAniRUT.jsp tardo en ejecutarse:" + elapsedTime;
