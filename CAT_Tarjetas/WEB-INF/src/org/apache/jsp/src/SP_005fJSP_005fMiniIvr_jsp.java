 ...
 * Generated at: 2019-07-30 14:47:55 UTC
...
public final class SP_005fJSP_005fMiniIvr_jsp extends org.apache.jasper.runtime.HttpJspBase
...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	//OBTIENE VARIABLES DESDE COMPOSER
	String idLlamada = state.getString("CallUUID");
	String numMovil = state.getString("ANI");
	String varLlave = state.getString("var_LlaveMiniIvrDB");
    ...
    SQLServerCallableStatement cstmt = null;
	 ...
	 try 
	 {
         ...
         //ESPECIFICACION DEL NOMBRE DEL SP A LLAMAR Y PARAMETROS DE ENTRADA Y SALIDA
		 // (1) RETURN_VALUE, (2) @Llave varchar(10), (3) @Valor varchar(100) output
         cstmt = (SQLServerCallableStatement) con.prepareCall("{? = call dbo.SP_IVR_ConsultaMiniIVR(?, ?)}");													   
																
         //PASO DE VARIABLES
         cstmt.registerOutParameter(1, Types.INTEGER);
         cstmt.setString(2, varLlave);
		...
		//EJECUCION DEL SP
		 ...
		 varValor  = cstmt.getString(3);

         long stopTime = System.nanoTime();
		 long elapsedTime = (stopTime - startTime)/1000000;
		 LoggerMensaje += "Valor de Retorno de Ejecucion de SP:" + returnSP + " varValor[" + varValor + "]";
		 LoggerMensaje += " JS SP_JSP_MiniIvr.jsp tardo en ejecutarse:" + elapsedTime;
		...
		//FINALIZA TIMER
		 ...
		 result.put("var_ValorMinIvrDB",varValor);
  ...
  static {
    ...
    _jspx_dependants.put("/src/../include/backend.jspf", Long.valueOf(1562355580596L));
  }
